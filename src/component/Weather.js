        ...
        return (
            <div className="weather">
                <ul className="list-group list-group-flush">
                    ...
                    {this.state.data && <React.Fregment>
                        <li className="list-group-item"><h5>{this.state.data.name}</h5></li>
                        {/*<li className="list-group-item"><p>{this.state.weather.description}</p></li>*/}
                        {/*<li className="list-group-item">*/}
                            {/*<table>*/}
                                {/*<tr>*/}
                                    {/*<td>{this.state.main.temp}</td>*/}
                                    {/*<td>{this.state.weather.icon}</td>*/}
                                    {/*<td>{this.state.main.temp}</td>*/}
                                {/*</tr>*/}
                            {/*</table>*/}
                        {/*</li>*/}
